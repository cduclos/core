...
ENTERPRISE_VOID_FUNC_1ARG_DEFINE_STUB(void, InitializeUpdates, const char *, configuration_file)
{
    Log(LOG_LEVEL_VERBOSE, "Upgrade is only supported in CFEngine Enterprise");
}
